...
export default class Panel extends UserInterfaceElement {
	...
	static TOP_DIALOGUE = { x: 0, y: 0, width: CANVAS_WIDTH, height: 4.5 };
	...
	constructor(x, y, width, height, options = {}) {
		...
		this.borderColour = options.borderColour ?? Color.Grey;
		this.panelColour = options.panelColour ?? Color.White;
